        ...
        <div class="col-lg-8 col-md-8">
          <div id="titlebar" class="utf_listing_titlebar">
            <div class="utf_listing_titlebar_title">
              <h2 v-if="venue.category">
                {{ venue.title }}<span class="listing-tag">{{ venue.category['name_bg'] }}</span>
              </h2>
  
              <span>
                <a href="#utf_listing_location" class="listing-address">
                  <span class="i"><font-awesome-icon :icon="['fas', 'location-pin']" /></span>The Ritz-Carlton, Hong Kong
                </a>
              </span>
              <span class="call_now">
                <span class="i"><font-awesome-icon :icon="['fas', 'phone']" /></span> (415) 796-3633
              </span>
          ...
          <div id="utf_listing_overview" class="utf_listing_section">
            ...
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar neque. Nulla finibus lobortis
              pulvinar. Donec a consectetur nulla. Nulla posuere sapien vitae lectus suscipit, et pulvinar nisi tincidunt.
              Aliquam erat volutpat. Curabitur convallis fringilla diam sed aliquam. Sed tempor iaculis massa faucibus
            ...
            <div id="utf_listing_tags" class="utf_listing_section listing_tags_section margin-bottom-10 margin-top-0">
              <a href="#">
                <span class="i"><font-awesome-icon :icon="['fas', 'phone']" /></span> +(01) 1123-254-456
              </a>
              <a href="#">
                <span class="i"><font-awesome-icon :icon="['fas', 'envelope']" /></span>info@example.com
              </a>
              <a href="#">
                <span class="i"><font-awesome-icon :icon="['fas', 'globe']" /></span> www.example.com
              </a>
            </div>
          ...
          <div id="utf_listing_tags" class="utf_listing_section listing_tags_section">
            ...
            <a href="#">
                <span class="i"><font-awesome-icon :icon="['fas', 'tag']" /></span>Food
            </a>
            <a href="#">
                <span class="i"><font-awesome-icon :icon="['fas', 'tag']" /></span> Fruits
            </a>
            <a href="#">
                <span class="i"><font-awesome-icon :icon="['fas', 'tag']" /></span> Lunch
            </a>
            <a href="#">
                <span class="i"><font-awesome-icon :icon="['fas', 'tag']" /></span> Menu
            </a>
            <a href="#">
                <span class="i"><font-awesome-icon :icon="['fas', 'tag']" /></span> Parking
            </a>
            <a href="#">
                <span class="i"><font-awesome-icon :icon="['fas', 'tag']" /></span> Restaurant
            </a>
          </div>
              ...
              <ul>
                <li>
                  ...
                  <div class="utf_comment_content">
                    ...
                    <a href="#" class="rate-review">Helpful Review <font-awesome-icon :icon="['fas', 'thumbs-up']" /></a>
                    <div class="utf_by_comment">Francis Burton <span class="date"><font-awesome-icon :icon="['fas', 'clock']" /> Jan 05, 2021 - 8:52 am</span></div>
                    <p>
              ...
              <div class="col-md-12">
                <div class="utf_pagination_container_part margin-top-30">
                  <nav class="pagination">
                    <ul>
                      <li>
                        <a href="#"><font-awesome-icon :icon="['fas', 'arrow-left']" /></a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="#"><font-awesome-icon :icon="['fas', 'arrow-right']" /></a>
                      </li>
                    </ul>
                  </nav>
                </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="add-review-photos margin-bottom-30">
                    <div class="photoUpload">
                        Upload Photo <span class="i"> <font-awesome-icon :icon="['fas', 'circle-arrow-up']" /></span>
