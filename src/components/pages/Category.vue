	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-md-8">
				...
				<div class="row">
						<div v-for="venue in category.venues" :key="venue.id" class="col-lg-12 col-md-12">
						<div class="utf_listing_item-container list-layout">
						<router-link :to="{ name:'showVenue', params: { id : venue.id } }" class="utf_listing_item">
...
import axios from 'axios';
		...
		export default {
				...
				mounted() {
						axios.get('http://preporuka.zhechev.eu/api/categories/'+this.categoryId).then(({data})=>{
								this.category = data;
						})
				},
				computed: {
